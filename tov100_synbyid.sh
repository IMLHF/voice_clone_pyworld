...
if [[ -z "$1" ]]; then
  echo "Default Destination: Voice_Cloning_byid_pyworld"
  dest="english_voice_clone/Voice_Cloning_byid_pyworld"
else
  dest="$1"
fi
...
echo "To P40:/home/zhangwenbo5/worklhf/$dest"
# exit 0
rsync -avh -e "ssh -p 22 -o ProxyCommand='ssh -p 8695 zhangwenbo5@120.92.114.84 -W %h:%p'" --exclude-from='.vscode/exclude.lst' ./* zhangwenbo5@ksai-V100-3:/home/zhangwenbo5/worklhf/$dest
