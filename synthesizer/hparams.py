...
hparams = HParams(
    ...
    num_mels=1027, # pyworld feat  # Number of mel-spectrogram channels and local conditioning dimensionality
    #  network
    ...
    tacotron_batch_size=64, # init=36  # number of training samples on each training steps (was 32)
    ...
    ### SV2TTS ###
    speaker_embedding_size=251,
    silence_min_duration_split=0.4, # Duration in seconds of a silence for an utterance to be split
    utterance_min_duration=1.6,     # Duration in seconds below which utterances are discarded
    speaker_embedding_size_fin=256,
